...
export class ApiService {
  ...
  post(cat1:string, cat2:string, cat3:string = 'galeria', paquete:any = false, data:any): Observable<any>{
  ...
  put(cat1:string, cat2:string, cat3:string = 'galeria', id:number, data:any): Observable<any>{
  ...
  delete(cat1:string, cat2:string, cat3:string = 'galeria', id:number, items:any = false): Observable<any>{
